  ...
  "ally": {
          ...
          "textFields": [
            // Текстовое поле с пометкой мертвого
            {
              ...
              "color": "0xC8FFA6",                  // цвет (допускается использование динамического цвета, см. readme-ru.txt)
              "font": {                       // параметры шрифта
              ...
              "format": "\u004F"         // формат текста. См. описание макросов в readme-ru.txt
            }
          ]
        },
  "enemy": {
          ...
          "textFields": [
            // Текстовое поле с пометкой мертвого
            {
              ...
              "x": 0,                         // положение по оси X
              "y": -27,                       // положение по оси Y
              "alpha": 65,                   // прозрачность (допускается использование динамической прозрачности, см. readme-ru.txt)
              "color": "0xFCA9A4",                  // цвет (допускается использование динамического цвета, см. readme-ru.txt)
              "font": {                       // параметры шрифта
                "name": "XVMSymbol",         //   название
                "size": 24,                   //   размер
                "align": "center",            //   выравнивание текста (left, center, right)
