...
battle
  ...
  hideXVMVersion:         true - отключить отображение версии xvm в верхнем левом углу экрана
...
battleLoading
  ...
  showChances:             true - включить отображение шансов на победу. Обсуждение: http://forum.bulychev.net/viewtopic.php?f=4&t=26
  removeSquadIcon:         true - убрать отображение иконки взвода. На пустое поле можно вывести, например, иконку клана.
  clanIcon:                параметры отображения иконки игрока/клана
    show:    - отображать (true) или нет (false)
  ...
  formatLeft:              "text" - формат отображения для левой панели (допускаются макроподстановки статистики - см.ниже)
  formatRight:             "text" - формат отображения для правой панели

statisticForm
  removeSquadIcon:         true - убрать отображение иконки взвода. На пустое поле можно вывести, например, иконку клана.
  showChances:             true - включить отображение шансов на победу (только в XVM Full, пока работает только в боях 15x15)
  clanIcon:                параметры отображения иконки игрока/клана (см. battleLoading)
  formatLeft:              "text" - формат отображения для левой панели (допускаются макроподстановки статистики - см.ниже)
  formatRight:             "text" - формат отображения для правой панели
