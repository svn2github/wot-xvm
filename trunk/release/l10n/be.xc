 ...
 */
{
  "locale": {
    ...
    "Specific damage (Avg dmg / HP)": "Магчымая шкода (сяр. пашкоджанні / HP)",
    "Capture points": "Захоп базы",
    "Defence points": "Абарона базы",
    "Filter": "Фільтр",
    ...
    "Average damage assisted": "Сяр. пашкоджанні з вашай дапамогай",
    "    by tracking": "    збіцём тракавага паса",
    "    by spotting": "    выяўленнем",
