...
public class VehicleTypeComponent
{
    ...
    private function draw(cfg:Object):void
    {
		...
		Utils.colorize(proxy.marker, proxy.formatDynamicColor(proxy.formatStaticColorText(cfg.color)),
			proxy.isDead ? Config.config.consts.VM_COEFF_VMM / 10 : Config.config.consts.VM_COEFF_VMM);
    }
}
