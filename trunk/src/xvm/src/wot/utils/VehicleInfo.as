...
class wot.utils.VehicleInfo
{
  ...
  private static var _data = {
    ...
    ussr_A_32:				{ level: 4,  type: MT, tiers: [ 4, 6 ] },
    ...
    germany_PzV_PzIV_ausf_Alfa:		{ level: 6,  type: MT, tiers: [ 6, 8 ] },
    germany_PzV_PzIV:			{ level: 6,  type: MT, tiers: [ 6, 8 ] },
    ...
    // level 8
    france_AMX_13_90:			{ level: 8,  type: LT, tiers: [ 9, 11 ] },
    china_Ch01_Type59:			{ level: 8,  type: MT, tiers: [ 8, 10 ] },
    germany_Panther_II:			{ level: 8,  type: MT, tiers: [ 8, 10 ] },
    usa_Pershing:			{ level: 8,  type: MT, tiers: [ 8, 10 ] },
    ussr_T_44:				{ level: 8,  type: MT, tiers: [ 8, 10 ] },
    usa_T26_E4_SuperPershing:           { level: 8,  type: MT, tiers: [ 8, 10 ] },
