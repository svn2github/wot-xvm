...
class wot.VehicleMarkersManager.components.damage.DamageTextAnimation
{
    ...
    public function DamageTextAnimation(animation:String, textField:TextField)
    {
        target = textField;
        ...
        try
        {
            Evaluator.evaluate(animation, this);
        }
        catch (ex)
        {
    ...
    public function alpha(value:Number):TweenLite
    {
        ...
        return TweenLite.to(target, 0.01, { _alpha:value } );
    }
    ...
    {
        //trace("color:" + com.xvm.JSON.stringify(arguments));
        return TweenLite.to(target, 0.01, {dropShadowFilter:value});
    }
