class net.wargaming.ingame.VehicleMarker extends gfx.core.UIComponent
{
    var m_playerFullName, m_vehicleClass, m_vname, initialized, __get__vehicleDestroyed, m_markerState, __get__colorSchemeName, __get__colorsManager, pNameField, vNameField, marker, healthBar, __get__isEnabledExInfo, actionMarker, iconLoader, levelIcon, invalidate, gotoAndStop;
