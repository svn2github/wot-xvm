...
{
    var _disabled, tabEnabled, focusEnabled, inspectableGroupName, _label, textField, initialized, _width, __width, _focused, focusIndicator, dispatchEvent, _group, _parent, _name, constraints, sizeIsInvalid, onRollOver, onRollOut, onPress, onRelease, onDragOver, onDragOut, onReleaseOutside, __height, _height, validateNow, invalidate, gotoAndPlay, _displayFocus, buttonRepeatInterval, doubleClickInterval;
    function Button()
    {
        super();
