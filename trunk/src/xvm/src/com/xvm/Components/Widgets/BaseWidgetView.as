...
class com.xvm.Components.Widgets.BaseWidgetView implements IWidgetView
{
    /////////////////////////////////////////////////////////////////
    // PRIVATE
    ...
    public function BaseWidgetView(mc:MovieClip, settings:Object, defaults:Object)
    {
        ...
        var me = this;
        this.mc = mc;
        mc._x = settings.x != null ? settings.x : defaults.x != null ? defaults.x : 300;
        mc._y = settings.y != null ? settings.y : defaults.y != null ? defaults.y : 100;
        
        mc._alpha = settings.alpha == null ? 50 : settings.alpha;
        mc.onRollOver = function()       { mc._alpha = settings.activeAlpha == null ? 100 : settings.activeAlpha; }
        mc.onRollOut = function()        { mc._alpha = settings.alpha == null ? 50 : settings.alpha; }
