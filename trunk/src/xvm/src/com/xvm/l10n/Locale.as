    ...
    public class Locale extends EventDispatcher
    {
        ...
        private static const FALLBACK_RU:Object = {
            ...
            */
            ...
            "Average battle life time": "Среднее время жизни в бою",
            "Battle life time per day": "Среднее время игры в день",
            "Battles after 0.8.8": "Боев после 0.8.8",
            "Average XP": "средний опыт",
            "Average XP without premium": "средний опыт без учета према",
            "Average km per battle": "в среднем пройдено км за бой",
            "Average tree cut per battle": "в среднем повалено деревьев",
            "Average damage assisted": "ср. урон с вашей помощью",
            "    ... track": "    ... после сбития гусеницы",
            "    ... radio": "    ... по разведданным",
            "Average splash damage": "в среднем нанесено урона сплэшем",
            "Average splash damage received": "в среднем получено урона сплэшем",
            "Average pierced per battle": "в среднем пробитий за бой",
            "Average shots received": "в среднем получено попаданий",
            "Average pierced received": "в среднем получено пробитий",
            "Average no dmg shots received": "в ср. получено попаданий без урона",
