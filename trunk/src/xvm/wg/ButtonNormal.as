package 
{
    ...
    public dynamic class ButtonNormal extends net.wg.gui.components.controls.SoundButtonEx
    {
        public function ButtonNormal()
        {
            super();
            ...
            this.__setProp_disableMc_ButtonNormal_disable_0();
            return;
        }

        internal function __setProp_disableMc_ButtonNormal_disable_0():*
        {
            try 
            {
