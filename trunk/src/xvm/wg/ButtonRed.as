package 
{
    ...
    public dynamic class ButtonRed extends net.wg.gui.components.controls.SoundButtonEx
    {
        public function ButtonRed()
        {
            ...
            this.__setProp_disableMc_ButtonRed_disable_0();
            return;
        }

        internal function __setProp_disableMc_ButtonRed_disable_0():*
        {
            try 
            {
