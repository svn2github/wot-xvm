package net.wg.gui.lobby.dialogs
{
   ...
   public class PriceMc extends UIComponent
   {
      ...
      override protected function draw() : void {
         ...
         {
            this.priceValue.text = this._currency == IconText.GOLD?App.utils.locale.gold(this._price):App.utils.locale.integer(this._price);
            this.priceValue.icon = this._currency;
            this.actionPrice.setData(this._actionPrc,this._price,this._defPrice,this._currency);
