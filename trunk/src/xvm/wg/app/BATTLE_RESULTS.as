package 
{
    public class BATTLE_RESULTS extends Object
    {
        ...
        public static function common_tooltip(arg1:String):String
        {
            var loc1:*="#battle_results:common/tooltip/" + arg1;
            App.utils.asserter.assert(!(COMMON_TOOLTIP_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }
        ...
        public static const COMMON_DETAILS_PROGRESS:String="#battle_results:common/details/progress";
        ...
        public static const TEAM_SQUADHEADER_HEADER:String=TEAM_SQUADHEADER + "/header";

        public static const TEAM_SQUADHEADER_BODY:String=TEAM_SQUADHEADER + "/body";

        public static const TEAM_PLAYERHEADER_HEADER:String=TEAM_PLAYERHEADER + "/header";

        public static const TEAM_PLAYERHEADER_BODY:String=TEAM_PLAYERHEADER + "/body";

        public static const TEAM_TANKHEADER_HEADER:String=TEAM_TANKHEADER + "/header";

        public static const TEAM_TANKHEADER_BODY:String=TEAM_TANKHEADER + "/body";
        ...
        public static const TEAM_DAMAGEHEADER_HEADER:String=TEAM_DAMAGEHEADER + "/header";

        public static const TEAM_DAMAGEHEADER_BODY:String=TEAM_DAMAGEHEADER + "/body";

        public static const TEAM_FRAGHEADER_HEADER:String=TEAM_FRAGHEADER + "/header";

        public static const TEAM_FRAGHEADER_BODY:String=TEAM_FRAGHEADER + "/body";

        public static const TEAM_XPHEADER_HEADER:String=TEAM_XPHEADER + "/header";

        public static const TEAM_XPHEADER_BODY:String=TEAM_XPHEADER + "/body";

        public static const TEAM_MEDALHEADER_HEADER:String=TEAM_MEDALHEADER + "/header";
