...
class wot.VehicleMarkersManager.components.damage.DamageTextProxy extends AbstractAccessProxy
{
    ...
    */
    ...
    {
        return xvm.wrapper.createEmptyMovieClip("xvm_damageHolder", xvm.wrapper.getNextHighestDepth());
    }
    ...
    {
        return xvm.m_entityName == 'teamKiller' ? (xvm.wrapper.m_team + "tk") : xvm.m_entityName;
    }
