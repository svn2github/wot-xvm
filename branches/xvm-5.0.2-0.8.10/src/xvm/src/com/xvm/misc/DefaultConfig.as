...
package com.xvm.misc
{
    ...
    public class DefaultConfig
    {
        ...
        private static function getBattleLoadingSection():CBattleLoading
        {
            ...
            c.formatLeftVehicle = "{{vehicle}}<font face='Lucida Console' size='12'> <font color='{{c:kb}}'>{{kb:3}}</font> <font color='{{c:xwn6}}'>{{xwn6}}</font> <font color='{{c:rating}}'>{{rating:3}}</font></font>";
            c.formatRightNick = "{{name}}{{clan}}";
            c.formatRightVehicle = "<font face='Lucida Console' size='12'><font color='{{c:rating}}'>{{rating:3}}</font> <font color='{{c:xwn6}}'>{{xwn6}}</font> <font color='{{c:kb}}'>{{kb:3}}</font> </font>{{vehicle}}";
            return c;
        }
        ...
        private static function getPlayersPanelSection():CPlayersPanel
        {
            ...
            c.medium = {
                ...
                width: 46,
                // Dispay format.
                formatLeft: "<font color='{{c:xwn6}}'>{{nick}}</font>",
                formatRight: "<font color='{{c:xwn6}}'>{{nick}}</font>"
            };
            // Medium2 mode.
            c.medium2 = {
                // 0..250 - player name field width.
                width: 65,
                // Dispay format.
                formatLeft: "<font color='{{c:xwn6}}'>{{vehicle}}</font>",
                formatRight: "<font color='{{c:xwn6}}'>{{vehicle}}</font>"
            };
            // Large mode.
            c.large = {
                // 0..250 - player name field width.
                ...
                vehicleFormatLeft: "<font color='{{c:xwn6}}'>{{vehicle}}</font>",
                vehicleFormatRight: "<font color='{{c:xwn6}}'>{{vehicle}}</font>"
            };
            return c;
        }
