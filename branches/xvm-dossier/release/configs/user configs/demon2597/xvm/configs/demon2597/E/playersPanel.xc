 ...
 */
{
  "playersPanel": {
    ...
    "medium": {
      ...
      "formatLeft": "  <font face='PartnerCondensed Mono'  color='{{c:e}}'>{{e}}</font>    <font color='{{c:xeff}}'>{{name}}</font> <font size='13' >{{clannb}}</font>",
      // Display format for the right panel (macros allowed, see readme-en.txt).
      // Формат отображения для правой панели (допускаются макроподстановки, см. readme-ru.txt).
      "formatRight": "<font size='13' >{{clannb}}</font> <font color='{{c:xeff}}'>{{name}}</font>    <font face='PartnerCondensed Mono'  color='{{c:e}}'>{{e}}</font>  <font size='0'>."
    },
    ...
    "medium2": {
      ...
      // Display format for the left panel (macros allowed, see readme-en.txt).
      // Формат отображения для левой панели (допускаются макроподстановки, см. readme-ru.txt).
      "formatLeft": "<font face='PartnerCondensed Mono' ><font color='{{c:xeff}}'>{{xeff}}</font>  <font color='{{c:e}}'>{{e}}</font></font>",
      // Display format for the right panel (macros allowed, see readme-en.txt).
      // Формат отображения для правой панели (допускаются макроподстановки, см. readme-ru.txt).
      "formatRight": "<font face='PartnerCondensed Mono' ><font color='{{c:e}}'>{{e}}</font>  <font color='{{c:xeff}}'>{{xeff}}</font></font>"
    },
    ...
    "large": {
      ...
      "vehicleFormatLeft": "<font face='PartnerCondensed Mono' ><font color='{{c:xeff}}'>{{xeff}}</font>  <font color='{{c:e}}'>{{e}}</font></font>",
      "vehicleFormatRight": "<font face='PartnerCondensed Mono' ><font color='{{c:e}}'>{{e}}</font>  <font color='{{c:xeff}}'>{{xeff}}</font>"
    }
  }
}
