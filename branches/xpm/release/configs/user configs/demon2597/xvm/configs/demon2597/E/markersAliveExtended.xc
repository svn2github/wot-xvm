...
"def": {
     ...
     // Шаблон текстовых полей.
        ...
        // Текстовое поле с эффективностямии количествами боев
            {
              "name": "xeff, E, hb, kb",             // название текстового поля, ни на что не влияет
              "visible": true,                // false - не отображать
              "x": 0,                         // положение по оси X
              ...
              "format": "<font color='{{c:t-battles}}'>{{t-hb}}</font>  <font color='{{c:e}}'>{{e}}</font>  <font color='{{c:xeff}}'>{{xeff}}</font>  <font color='{{c:kb}}'>{{kb}}</font>"         // формат текста. См. описание макросов в readme-ru.txt
            },
