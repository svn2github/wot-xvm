package 
{
    ...
    public dynamic class CamouflageGroupViewUI extends net.wg.gui.lobby.customization.CamouflageGroupView
    {
        public function CamouflageGroupViewUI()
        {
            super();
            this.__setProp_rentalPackageList_CamouflageGroupViewUI_list_0();
            this.__setProp_list_CamouflageGroupViewUI_Layer1_0();
            return;
        }

        internal function __setProp_rentalPackageList_CamouflageGroupViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_list_CamouflageGroupViewUI_Layer1_0():*
        {
            try 
            {
            ...
            list.focusable = true;
            list.itemRendererName = "CamouflageItemRendererUI";
