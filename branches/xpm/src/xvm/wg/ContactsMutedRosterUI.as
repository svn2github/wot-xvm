package 
{
    ...
    public dynamic class ContactsMutedRosterUI extends net.wg.gui.prebattle.invites.UserRosterView
    {
        public function ContactsMutedRosterUI()
        {
            super();
            this.__setProp_rosterList_ContactsMutedRoster_Layer1_0();
            return;
        }

        internal function __setProp_rosterList_ContactsMutedRoster_Layer1_0():*
        {
            var loc1:*;
            try 
            {
