package 
{
    ...
    public dynamic class InscriptionGroupViewUICopy extends net.wg.gui.lobby.customization.BaseTimedCustomizationGroupView
    {
        public function InscriptionGroupViewUICopy()
        {
            super();
            this.__setProp_list_InscriptionGroupViewUICopy_list_0();
            this.__setProp_rentalPackageList_InscriptionGroupViewUICopy_list_0();
            return;
        }

        internal function __setProp_list_InscriptionGroupViewUICopy_list_0():*
        {
            try 
            {
            ...
            list.columnWidth = 152;
            list.direction = "vertical";
            list.enabled = true;
            list.enableInitCallback = false;
            list.externalColumnCount = 0;
            list.focusable = true;
            list.itemRendererName = "InscriptionItemRendererUI";
            list.itemRendererInstanceName = "";
            list.margin = 0;
            list.inspectablePadding = {"top":5, "right":0, "bottom":2, "left":13};
        ...
        internal function __setProp_rentalPackageList_InscriptionGroupViewUICopy_list_0():*
        {
            try 
            {
