package 
{
    ...
    public dynamic class BSWindowChannelComponentUI extends net.wg.gui.messenger.ChannelComponent
    {
        public function BSWindowChannelComponentUI()
        {
            super();
            this.__setProp_messageArea_ChannelComponentUI_Layer1_0();
            this.__setProp_sendButton_ChannelComponentUI_Layer1_0();
            return;
        }

        internal function __setProp_messageArea_ChannelComponentUI_Layer1_0():*
        {
            try 
            {
        ...
        internal function __setProp_sendButton_ChannelComponentUI_Layer1_0():*
        {
            try 
            {
