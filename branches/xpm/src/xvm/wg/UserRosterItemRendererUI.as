package 
{
    ...
    public dynamic class UserRosterItemRendererUI extends net.wg.gui.prebattle.invites.UserRosterItemRenderer
    {
        public function UserRosterItemRendererUI()
        {
            ...
            this.__setProp_voiceWave_UserRosterItemRenderer_Layer2_0();
            return;
        }

        internal function __setProp_voiceWave_UserRosterItemRenderer_Layer2_0():*
        {
            var loc1:*;
            try 
            {
