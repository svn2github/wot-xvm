package 
{
    ...
    public dynamic class BlinkingButton_UI extends net.wg.gui.components.advanced.BlinkingButton
    {
        public function BlinkingButton_UI()
        {
            super();
            ...
            this.__setProp_disableMc_BlinkingButton_UI_disable_mc_0();
            return;
        }

        internal function __setProp_disableMc_BlinkingButton_UI_disable_mc_0():*
        {
            try 
            {
