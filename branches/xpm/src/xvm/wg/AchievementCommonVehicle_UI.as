package 
{
    ...
    public dynamic class AchievementCommonVehicle_UI extends net.wg.gui.components.controls.achievements.AchievementCommonVehicle
    {
        public function AchievementCommonVehicle_UI()
        {
            super();
            addFrameScript(9, this.frame10, 19, this.frame20, 29, this.frame30, 39, this.frame40, 49, this.frame50, 59, this.frame60);
            this.__setProp_loader_AchievementCommonVehicle_UI_loder_0();
            return;
        }

        internal function __setProp_loader_AchievementCommonVehicle_UI_loder_0():*
        {
            try 
            {
