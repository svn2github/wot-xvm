package 
{
    ...
    public dynamic class RootNodeNameAndXp extends net.wg.gui.lobby.techtree.controls.NameAndXpField
    {
        public function RootNodeNameAndXp()
        {
        ...
        internal function __setProp_xpIcon_RootNodeNameAndXp_xp_0():*
        {
        ...
        internal function __setProp_xpIcon_RootNodeNameAndXp_xp_4():*
        {
        ...
        {
            this.__setProp_xpIcon_RootNodeNameAndXp_xp_0();
            stop();
            return;
        }
        ...
        {
            this.__setProp_xpIcon_RootNodeNameAndXp_xp_4();
            stop();
            return;
        }
