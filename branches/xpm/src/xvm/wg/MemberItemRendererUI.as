package 
{
    ...
    public dynamic class MemberItemRendererUI extends net.wg.gui.messenger.controls.MemberItemRenderer
    {
        public function MemberItemRendererUI()
        {
            super();
            ...
            this.__setProp_voiceWave_MemberItemRenderer_voicechat_0();
            return;
        }

        internal function __setProp_voiceWave_MemberItemRenderer_voicechat_0():*
        {
            var loc1:*;
            try 
            {
            ...
            voiceWave.cross_x = 18;
            voiceWave.cross_y = 10;
