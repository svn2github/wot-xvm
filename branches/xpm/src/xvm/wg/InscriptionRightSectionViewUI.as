package 
{
    ...
    public dynamic class InscriptionRightSectionViewUI extends net.wg.gui.lobby.customization.InscriptionRightSectionView
    {
        public function InscriptionRightSectionViewUI()
        {
            super();
            this.__setProp_list_InscriptionRightSectionViewUI_list_0();
            this.__setProp_currentItemRenderer_InscriptionRightSectionViewUI_current();
            this.__setProp_newItemRenderer_InscriptionRightSectionViewUI_current();
            return;
        }

        internal function __setProp_list_InscriptionRightSectionViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_currentItemRenderer_InscriptionRightSectionViewUI_current():*
        {
            try 
            {
        ...
        internal function __setProp_newItemRenderer_InscriptionRightSectionViewUI_current():*
        {
            try 
            {
