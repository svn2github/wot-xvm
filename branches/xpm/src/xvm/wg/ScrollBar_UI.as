package 
{
    ...
    public dynamic class ScrollBar_UI extends net.wg.gui.components.controls.ScrollBar
    {
        public function ScrollBar_UI()
        {
            super();
            this.__setProp_upArrowWg_ScrollBar_UI_btns_0();
            return;
        }

        internal function __setProp_upArrowWg_ScrollBar_UI_btns_0():*
        {
            try 
            {
