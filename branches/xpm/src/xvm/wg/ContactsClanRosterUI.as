package 
{
    ...
    public dynamic class ContactsClanRosterUI extends net.wg.gui.prebattle.invites.UserRosterView
    {
        public function ContactsClanRosterUI()
        {
            super();
            this.__setProp_rosterList_ContactsClanRoster_Layer1_0();
            return;
        }

        internal function __setProp_rosterList_ContactsClanRoster_Layer1_0():*
        {
            var loc1:*;
            try 
            {
