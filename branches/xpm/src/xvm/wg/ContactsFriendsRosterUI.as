package 
{
    ...
    public dynamic class ContactsFriendsRosterUI extends net.wg.gui.prebattle.invites.UserRosterView
    {
        public function ContactsFriendsRosterUI()
        {
            super();
            this.__setProp_rosterList_ContactsFriendsRoster_Layer1_0();
            return;
        }

        internal function __setProp_rosterList_ContactsFriendsRoster_Layer1_0():*
        {
            var loc1:*;
            try 
            {
