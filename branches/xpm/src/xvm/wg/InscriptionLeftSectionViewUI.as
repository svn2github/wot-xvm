package 
{
    ...
    public dynamic class InscriptionLeftSectionViewUI extends net.wg.gui.lobby.customization.InscriptionLeftSectionView
    {
        public function InscriptionLeftSectionViewUI()
        {
            super();
            this.__setProp_list_InscriptionLeftSectionViewUI_list_0();
            this.__setProp_currentItemRenderer_InscriptionLeftSectionViewUI_current();
            this.__setProp_newItemRenderer_InscriptionLeftSectionViewUI_current();
            return;
        }

        internal function __setProp_list_InscriptionLeftSectionViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_currentItemRenderer_InscriptionLeftSectionViewUI_current():*
        {
            try 
            {
        ...
        internal function __setProp_newItemRenderer_InscriptionLeftSectionViewUI_current():*
        {
            try 
            {
