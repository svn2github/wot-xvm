package 
{
    ...
    public dynamic class EmblemRightSectionViewUI extends net.wg.gui.lobby.customization.EmblemRightSectionView
    {
        public function EmblemRightSectionViewUI()
        {
            super();
            this.__setProp_list_EmblemRightSectionViewUI_list_0();
            this.__setProp_currentItemRenderer_EmblemRightSectionViewUI_current();
            this.__setProp_newItemRenderer_EmblemRightSectionViewUI_current();
            return;
        }

        internal function __setProp_list_EmblemRightSectionViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_currentItemRenderer_EmblemRightSectionViewUI_current():*
        {
            try 
            {
        ...
        internal function __setProp_newItemRenderer_EmblemRightSectionViewUI_current():*
        {
            try 
            {
