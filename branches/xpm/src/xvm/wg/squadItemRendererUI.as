package 
{
    ...
    public dynamic class squadItemRendererUI extends net.wg.gui.prebattle.squad.SquadItemRenderer
    {
        public function squadItemRendererUI()
        {
            super();
            ...
            this.__setProp_voiceWave_squadItemRendererUI_voice_0();
            return;
        }

        internal function __setProp_voiceWave_squadItemRendererUI_voice_0():*
        {
            try 
            {
