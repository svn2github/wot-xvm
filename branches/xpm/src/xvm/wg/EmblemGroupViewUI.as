package 
{
    ...
    public dynamic class EmblemGroupViewUI extends net.wg.gui.lobby.customization.BaseTimedCustomizationGroupView
    {
        public function EmblemGroupViewUI()
        {
            super();
            this.__setProp_list_EmblemGroupViewUI_list_0();
            this.__setProp_rentalPackageList_EmblemGroupViewUI_list_0();
            return;
        }

        internal function __setProp_list_EmblemGroupViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_rentalPackageList_EmblemGroupViewUI_list_0():*
        {
            try 
            {
