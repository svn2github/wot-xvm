package 
{
    ...
    public dynamic class NationTreeNodeSkinned extends net.wg.gui.lobby.techtree.nodes.NationTreeNode
    {
        public function NationTreeNodeSkinned()
        {
            this.__setPropDict = new flash.utils.Dictionary(true);
            super();
            addFrameScript(7, this.frame8, 15, this.frame16, 16, this.frame17, 31, this.frame32, 39, this.frame40, 47, this.frame48, 55, this.frame56, 63, this.frame64, 71, this.frame72, 79, this.frame80, 88, this.frame89, 96, this.frame97, 104, this.frame105, 112, this.frame113, 120, this.frame121, 129, this.frame130, 137, this.frame138, 145, this.frame146, 153, this.frame154, 161, this.frame162, 169, this.frame170, 178, this.frame179, 186, this.frame187, 194, this.frame195, 203, this.frame204, 212, this.frame213, 221, this.frame222, 230, this.frame231, 238, this.frame239, 247, this.frame248, 256, this.frame257, 264, this.frame265, 273, this.frame274, 282, this.frame283, 291, this.frame292, 300, this.frame301, 308, this.frame309, 316, this.frame317, 324, this.frame325, 333, this.frame334, 341, this.frame342, 350, this.frame351, 358, this.frame359, 366, this.frame367, 375, this.frame376, 384, this.frame385);
            this.__setProp_vIconLoader_NationTreeNodeSkinned_vehicleicon_0();
        ...
        internal function __setProp_vIconLoader_NationTreeNodeSkinned_vehicleicon_0():*
        {
            try 
            {
            ...
            vIconLoader.source = "";
            vIconLoader.sourceAlt = "../maps/icons/vehicle/small/noImage.png";
        ...
        internal function __setProp_typeAndLevel_NationTreeNodeSkinned_typeandlevel_0(arg1:int):*
        {
        ...
        internal function __setProp_typeAndLevel_NationTreeNodeSkinned_typeandlevel_170(arg1:int):*
        {
            if (!(typeAndLevel == null) && arg1 >= 171 && arg1 <= 385 && (this.__setPropDict[typeAndLevel] == undefined || !(int(this.__setPropDict[typeAndLevel]) >= 171 && int(this.__setPropDict[typeAndLevel]) <= 385))) 
            {
                this.__setPropDict[typeAndLevel] = arg1;
                try 
                {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_0(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_48(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_89(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_130(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_170(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_257(arg1:int):*
        {
        ...
        internal function __setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_342(arg1:int):*
        {
            if (!(nameAndXp == null) && arg1 >= 343 && arg1 <= 385 && (this.__setPropDict[nameAndXp] == undefined || !(int(this.__setPropDict[nameAndXp]) >= 343 && int(this.__setPropDict[nameAndXp]) <= 385))) 
            {
                this.__setPropDict[nameAndXp] = arg1;
                try 
                {
        ...
        internal function __setProp_button_NationTreeNodeSkinned_buy(arg1:int):*
        {
        ...
        internal function __setProp_button_NationTreeNodeSkinned_buy_1(arg1:int):*
        {
        ...
        internal function __setProp_button_NationTreeNodeSkinned_buy_2(arg1:int):*
        {
        ...
        internal function __setProp_button_NationTreeNodeSkinned_buy_3(arg1:int):*
        {
            if (!(button == null) && arg1 >= 343 && arg1 <= 385 && (this.__setPropDict[button] == undefined || !(int(this.__setPropDict[button]) >= 343 && int(this.__setPropDict[button]) <= 385))) 
            {
                this.__setPropDict[button] = arg1;
                try 
                {
        ...
        internal function __setProp_handler(arg1:Object):*
        {
            ...
            this.__setProp_typeAndLevel_NationTreeNodeSkinned_typeandlevel_0(loc1);
            this.__setProp_typeAndLevel_NationTreeNodeSkinned_typeandlevel_170(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_0(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_48(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_89(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_130(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_170(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_257(loc1);
            this.__setProp_nameAndXp_NationTreeNodeSkinned_nameandxp_342(loc1);
            this.__setProp_button_NationTreeNodeSkinned_buy(loc1);
            this.__setProp_button_NationTreeNodeSkinned_buy_1(loc1);
            this.__setProp_button_NationTreeNodeSkinned_buy_2(loc1);
            this.__setProp_button_NationTreeNodeSkinned_buy_3(loc1);
            return;
        }
