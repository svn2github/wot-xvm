package 
{
    ...
    public dynamic class QuestsWindow_UI extends net.wg.gui.lobby.questsWindow.QuestsWindow
    {
        public function QuestsWindow_UI()
        {
            super();
            this.__setProp_tabs_mc_QuestsWindow_UI_header_0();
            this.__setProp_view_mc_QuestsWindow_UI_header_0();
            return;
        }

        internal function __setProp_tabs_mc_QuestsWindow_UI_header_0():*
        {
            try 
            {
        ...
        internal function __setProp_view_mc_QuestsWindow_UI_header_0():*
        {
            try 
            {
