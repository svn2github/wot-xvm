package 
{
    ...
    public dynamic class ClanMembersListFromUI extends net.wg.gui.prebattle.invites.UserRosterView
    {
        public function ClanMembersListFromUI()
        {
            super();
            this.__setProp_rosterList_ClanMembersListFromUI_Layer1_0();
            return;
        }

        internal function __setProp_rosterList_ClanMembersListFromUI_Layer1_0():*
        {
            try 
            {
