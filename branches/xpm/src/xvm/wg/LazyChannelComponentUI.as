package 
{
    ...
    public dynamic class LazyChannelComponentUI extends net.wg.gui.messenger.ChannelComponent
    {
        public function LazyChannelComponentUI()
        {
            super();
            this.__setProp_messageArea_LazyChannelComponentUI_Layer1_0();
            this.__setProp_sendButton_LazyChannelComponentUI_Layer1_0();
            return;
        }

        internal function __setProp_messageArea_LazyChannelComponentUI_Layer1_0():*
        {
            try 
            {
        ...
        internal function __setProp_sendButton_LazyChannelComponentUI_Layer1_0():*
        {
            try 
            {
