package 
{
    ...
    public dynamic class optionalDeviceViewUI extends net.wg.gui.lobby.store.views.OptionalDeviceView
    {
        public function optionalDeviceViewUI()
        {
            super();
            addFrameScript(0, this.frame1, 1, this.frame2);
            this.__setProp_myVehicleRadioBtn_optionalDeviceView_myVehicle_0();
            this.__setProp_fitsSelectDropDn_optionalDeviceView_fitsSelect_0();
            this.__setProp_otherVehiclesRadioBtn_optionalDeviceView_otherVehicles_0();
            this.__setProp_myVehiclesRadioBtn_optionalDeviceView_myVehicles_0();
            return;
        }

        internal function __setProp_myVehicleRadioBtn_optionalDeviceView_myVehicle_0():*
        {
            try 
            {
            ...
            myVehicleRadioBtn.groupName = "optionalDeviceGroup";
        ...
        internal function __setProp_fitsSelectDropDn_optionalDeviceView_fitsSelect_0():*
        {
            try 
            {
        ...
        internal function __setProp_otherVehiclesRadioBtn_optionalDeviceView_otherVehicles_0():*
        {
            try 
            {
            ...
            otherVehiclesRadioBtn.groupName = "optionalDeviceGroup";
        ...
        internal function __setProp_myVehiclesRadioBtn_optionalDeviceView_myVehicles_0():*
        {
            try 
            {
            ...
            myVehiclesRadioBtn.groupName = "optionalDeviceGroup";
