package 
{
    ...
    public dynamic class InscriptionGroupViewUI extends net.wg.gui.lobby.customization.BaseTimedCustomizationGroupView
    {
        public function InscriptionGroupViewUI()
        {
            super();
            this.__setProp_list_InscriptionGroupViewUI_list_0();
            this.__setProp_rentalPackageList_InscriptionGroupViewUI_list_0();
            return;
        }

        internal function __setProp_list_InscriptionGroupViewUI_list_0():*
        {
            try 
            {
        ...
        internal function __setProp_rentalPackageList_InscriptionGroupViewUI_list_0():*
        {
            try 
            {
