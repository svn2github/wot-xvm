 ...
 */
{
  "locale": {
    ...
    "token/days_left": "Zostávajú dní:<tab/><font color='#eeeeee'>%d</font>",
    "token/hours_left": "Zostávajú hodiny:<tab/><font color='#ffff00'>%d</font>",
    "token/cnt": "Počet prístupov:<tab/><font color='#eeeeee'>%d</font>",
