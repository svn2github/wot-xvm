 ...
 */
{
  "locale": {
    ...
    "token/days_left": "Zůstáva dnů:<tab/><font color='#eeeeee'>%d</font>",
    "token/hours_left": "Zůstáva hodin:<tab/><font color='#ffff00'>%d</font>",
    "token/cnt": "Počet přístupů:<tab/><font color='#eeeeee'>%d</font>",
