 ...
 */
{
  "locale": {
    ...
    "token/days_left": "Pozostało dni:<tab/><font color='#eeeeee'>%d</font>",
    "token/hours_left": "Pozostało godzin:<tab/><font color='#ffff00'>%d</font>",
    "token/cnt": "Liczba zapytań:<tab/><font color='#eeeeee'>%d</font>",
