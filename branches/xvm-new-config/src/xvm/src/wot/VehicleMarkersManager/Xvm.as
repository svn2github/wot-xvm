...
*/
    ...
    function updateHealth(newHealth, flag, damageType)
    {
        ...
        if (delta < 0) // Damage has been done
        {
            ...
            damageTextComponent.showDamage(flag == Defines.FROM_PLAYER ? vehicleStateCfg.damageTextPlayer
                : flag == Defines.FROM_SQUAD ? vehicleStateCfg.damageTextSquadman
                : vehicleStateCfg.damageText,
