package net.wg.gui.components.tooltips.VO
{
   ...
   public class SuitableVehicleVO extends DAAPIDataClass implements IDisposable
   {
      ...
      public var vehiclesList:Vector.<Vehicle> = null;
         ...
         switch(param1)
         {
            case "vehicles":
               ...
               if((_loc3_) && _loc3_.length > 0)
               {
                  ...
                  {
                     _loc6_ = new Vehicle(_loc3_[_loc4_]);
                     this.vehiclesList.push(_loc6_);
                     _loc4_++;
                  }
                  this.leftCount = _loc3_.length - _loc4_ > 0?_loc3_.length - _loc4_:0;
               }
               return false;
            case "conditions":
               if(App.instance)
