package 
{
    public class MENU extends Object
    {
        ...
        public static function moduleinfo_compatible(arg1:String):String
        {
            var loc1:*="#menu:moduleInfo/compatible/" + arg1;
            App.utils.asserter.assert(!(MODULEINFO_COMPATIBLE_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function nation_tree_title(arg1:String):String
        {
            var loc1:*="#menu:nation_tree/title/" + arg1;
            if (NATION_TREE_TITLE_ENUM.indexOf(loc1) == -1) 
            {
                DebugUtils.LOG_WARNING("[nation_tree_title]:locale key \"" + loc1 + "\" was not found");
                return null;
            }
            return loc1;
        }

        public static function tankmantrainingwindow(arg1:String):String
        {
            var loc1:*="#menu:tankmanTrainingWindow/" + arg1;
            App.utils.asserter.assert(!(TANKMANTRAININGWINDOW_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function shop_menu(arg1:String):String
        {
            var loc1:*="#menu:shop/menu/" + arg1;
            App.utils.asserter.assert(!(SHOP_MENU_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function moduleinfo_params(arg1:String):String
        {
            var loc1:*="#menu:moduleInfo/params/" + arg1;
            App.utils.asserter.assert(!(MODULEINFO_PARAMS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function skilldropwindow_study(arg1:String):String
        {
            var loc1:*="#menu:skillDropWindow/study/" + arg1;
            App.utils.asserter.assert(!(SKILLDROPWINDOW_STUDY_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function inventory_menu(arg1:String):String
        {
            var loc1:*="#menu:inventory/menu/" + arg1;
            App.utils.asserter.assert(!(INVENTORY_MENU_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function tank_params(arg1:String):String
        {
            var loc1:*="#menu:tank_params/" + arg1;
            App.utils.asserter.assert(!(TANK_PARAMS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function loading_battletypes(arg1:String):String
        {
            var loc1:*="#menu:loading/battleTypes/" + arg1;
            App.utils.asserter.assert(!(LOADING_BATTLETYPES_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function tankcarousel_vehiclestates(arg1:String):String
        {
            var loc1:*="#menu:tankCarousel/vehicleStates/" + arg1;
            App.utils.asserter.assert(!(TANKCAROUSEL_VEHICLESTATES_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function shop_table_header_count(arg1:String):String
        {
            var loc1:*="#menu:shop/table/header/count/" + arg1;
            App.utils.asserter.assert(!(SHOP_TABLE_HEADER_COUNT_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function tankmen(arg1:String):String
        {
            var loc1:*="#menu:tankmen/" + arg1;
            App.utils.asserter.assert(!(TANKMEN_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function denunciation(arg1:String):String
        {
            var loc1:*="#menu:denunciation/" + arg1;
            App.utils.asserter.assert(!(DENUNCIATION_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function vehicleinfo_params(arg1:String):String
        {
            var loc1:*="#menu:vehicleInfo/params/" + arg1;
            App.utils.asserter.assert(!(VEHICLEINFO_PARAMS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function loading_battletypes_desc(arg1:String):String
        {
            var loc1:*="#menu:loading/battleTypes/desc/" + arg1;
            App.utils.asserter.assert(!(LOADING_BATTLETYPES_DESC_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function profile_stats_blocks(arg1:String):String
        {
            var loc1:*="#menu:profile/stats/blocks/" + arg1;
            App.utils.asserter.assert(!(PROFILE_STATS_BLOCKS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function profile_stats_items(arg1:String):String
        {
            var loc1:*="#menu:profile/stats/items/" + arg1;
            App.utils.asserter.assert(!(PROFILE_STATS_ITEMS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function login_status(arg1:String):String
        {
            var loc1:*="#menu:login/status/" + arg1;
            App.utils.asserter.assert(!(LOGIN_STATUS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function training_info(arg1:String):String
        {
            var loc1:*="#menu:training/info/" + arg1;
            App.utils.asserter.assert(!(TRAINING_INFO_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function premium_periods(arg1:String):String
        {
            var loc1:*="#menu:premium/periods/" + arg1;
            App.utils.asserter.assert(!(PREMIUM_PERIODS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function contextmenu(arg1:String):String
        {
            var loc1:*="#menu:contextMenu/" + arg1;
            App.utils.asserter.assert(!(CONTEXTMENU_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function nations(arg1:String):String
        {
            var loc1:*="#menu:nations/" + arg1;
            App.utils.asserter.assert(!(NATIONS_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }

        public static function tankmanrecruitrenderer(arg1:String):String
        {
            var loc1:*="#menu:tankmanRecruitRenderer/" + arg1;
            App.utils.asserter.assert(!(TANKMANRECRUITRENDERER_ENUM.indexOf(loc1) == -1), "locale key \"" + loc1 + "\" was not found");
            return loc1;
        }
        ...
        public static const HEADERBUTTONS_BATTLE_TYPES_TEAMLEAVEOWNER:String="#menu:headerButtons/battle/types/teamLeaveOwner";

        public static const HEADERBUTTONS_BATTLE_TYPES_TEAMLEAVE:String="#menu:headerButtons/battle/types/teamLeave";
        ...
        public static const LOADING_BATTLETYPES_DESC_ENUM:Array=[LOADING_BATTLETYPES_DESC_0, LOADING_BATTLETYPES_DESC_1, LOADING_BATTLETYPES_DESC_2, LOADING_BATTLETYPES_DESC_3, LOADING_BATTLETYPES_DESC_4];
